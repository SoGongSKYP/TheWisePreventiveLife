...
public class DBEntity{
   ...
   // private DB db;
    ...
    public DBEntity() throws ParseException {
        ...
        Date dumD1= simpleDateFormat.parse("2020-10-21");
        Date dumD2= simpleDateFormat.parse("2020-12-21");
        //2. 더미 장소 객체 생성
        Place dumP1=new Place("파주",1.1,1.2);
        Place dumP2=new Place("서울",2.1,2.2);

        //3. 1,2로 확진자 방문장소 더미객체 생성
        VisitPlace dumVP1=new VisitPlace(dumP1,dumD1);
        VisitPlace dumVP2=new VisitPlace(dumP2,dumD1);
        VisitPlace dumVP3=new VisitPlace(dumP1,dumD2);
        ...
        dumVSP2.add(dumVP3);
        //5. 확진자 두명
        Patient dumPatient=new Patient(0,12,"1",dumD1,dumVSP1);
        Patient dumPatient2=new Patient(8,1,"2",dumD2,dumVSP2);
